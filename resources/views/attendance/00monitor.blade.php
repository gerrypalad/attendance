                ...
                .then(result => {
                    ...
                    result.data.forEach(emp => {
                        ...
                        if(emp.status === 'working') {
                            statusBadge = `<span class="badge bg-success-subtle text-success border px-3 py-2"><i class="bi bi-circle-fill me-1"></i> Working</span>`;
                            ...
                            statusBadge = `<span class="badge bg-warning-subtle text-warning border px-3 py-2"><i class="bi bi-pause-circle me-1"></i> On Break</span>`;
                            timerAttr = `data-start="${emp.raw_time_in}" data-break-out="${emp.raw_break_out}" data-break-in="${emp.raw_break_in}"`;
                        } else if(emp.status === 'shift_end') {
                            statusBadge = `<span class="badge bg-secondary-subtle text-secondary border px-3 py-2"><i class="bi bi-box-arrow-right me-1"></i> Completed</span>`;
                        } else {
                            statusBadge = `<span class="badge bg-light text-muted border px-3 py-2"><i class="bi bi-circle me-1"></i> Off Duty</span>`;
                        }
                            ...
                            <tr>
                                <td class="ps-4 py-3">
                                    <div class="d-flex align-items-center gap-2">
                                        ...
                                        <div>
                                            <div class="fw-semibold text-dark">${emp.username}</div>
                                ...
                                <td class="py-3">
                                    <div class="d-flex flex-column gap-1">
                                        ${statusBadge}
                                        <span class="live-timer badge bg-dark text-white px-3 py-1 small" ${timerAttr}>00:00:00</span>
                                    </div>
                                </td>
                                <td class="py-3 fw-medium text-dark">${emp.time_in}</td>
                                <td class="py-3 fw-medium text-dark">${emp.break_out}</td>
                                <td class="py-3 fw-medium text-dark">${emp.break_in}</td>
                                <td class="py-3 fw-medium text-dark">${emp.time_out}</td>
